...
<body>
    <div id="app">
        <!-- ヘッダーとバナーを表示する条件 -->
        @if (!Route::is('login') && !Route::is('register')) <!-- ログイン、新規登録ページでは表示しない -->
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/timetable') }}">時間割</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/progress') }}">授業進捗</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/profile') }}">プロフィール設定</a>
                            </li>
                        </ul>
